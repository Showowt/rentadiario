    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 -right-1/4 w-[500px] h-[500px] bg-amber-600/10 rounded-full blur-[100px] animate-pulse delay-1000" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-amber-500/5 to-transparent rounded-full blur-[80px]" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-3 max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-1 bg-white/5 rounded-2xl px-6 py-4 text-left hover:bg-white/10 transition cursor-pointer group">
                <label className="text-xs text-white/40 uppercase tracking-wider">Destino</label>
                <div className="text-white font-medium group-hover:text-amber-400 transition">¿A dónde vamos?</div>
              </div>
              ...
              <Link href="/buscar" className="bg-gradient-to-r from-amber-400 to-amber-600 text-black font-semibold px-8 py-4 rounded-2xl hover:shadow-lg hover:shadow-amber-500/25 transition-all hover:scale-[1.02] flex items-center justify-center gap-2">
      ...
      <section className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link href="/buscar" className="hidden md:flex items-center gap-2 text-amber-400 hover:text-amber-300 transition">
              Ver todos
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Link key={dest.name} href={`/buscar?ciudad=${dest.name}`} className={`group relative overflow-hidden rounded-3xl ${i === 0 ? 'md:col-span-2 md:row-span-2' : ''}`}>
                ...
                <div className={`relative ${i === 0 ? 'p-8 md:p-12 aspect-square md:aspect-auto md:h-full' : 'p-6 aspect-square'}`}>
                  ...
                  <div className="absolute top-6 right-6 w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white/30 transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featured.map((property) => (
              <Link key={property.id} href={`/propiedad/${property.id}`} className="group">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:border-amber-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/10 hover:-translate-y-2">
                  {/* Image */}
                  <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-slate-700 to-slate-800">
                    ...
                    <div className="absolute top-4 right-4 z-20">
                      <button className="w-10 h-10 bg-black/30 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-black/50 transition">
                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="absolute bottom-4 left-4 z-20 flex items-center gap-1">
                      ...
                      <span className="text-white/60 text-sm">({property.review_count})</span>
                    </div>
      ...
      <section className="relative py-32 px-6">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <Link href="#" className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-400 to-amber-600 text-black font-semibold px-8 py-4 rounded-full hover:shadow-lg hover:shadow-amber-500/25 transition-all hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-white/40 text-sm">La plataforma líder de alquileres a corto plazo en Colombia.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Explorar</h4>
              <div className="space-y-2 text-white/40 text-sm">
                <div><Link href="/buscar" className="hover:text-white transition">Buscar propiedades</Link></div>
                <div><Link href="#" className="hover:text-white transition">Destinos populares</Link></div>
                <div><Link href="#" className="hover:text-white transition">Experiencias</Link></div>
              </div>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Anfitriones</h4>
              <div className="space-y-2 text-white/40 text-sm">
                <div><Link href="#" className="hover:text-white transition">Publica tu propiedad</Link></div>
                <div><Link href="#" className="hover:text-white transition">Centro de recursos</Link></div>
                <div><Link href="#" className="hover:text-white transition">Comunidad</Link></div>
              </div>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Soporte</h4>
              <div className="space-y-2 text-white/40 text-sm">
                <div><Link href="#" className="hover:text-white transition">Centro de ayuda</Link></div>
                <div><Link href="#" className="hover:text-white transition">Contacto</Link></div>
                <div><Link href="#" className="hover:text-white transition">Términos y condiciones</Link></div>
              </div>
            </div>
          </div>
          
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
            <p className="text-white/40 text-sm">© 2025 RentaDiario. Todos los derechos reservados.</p>
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              <span className="text-white/40 text-sm">Hecho con 🇨🇴 en Colombia</span>
            </div>
          </div>
        </div>
      </footer>
